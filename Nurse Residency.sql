...
----NURSE RESIDENCY PATHWAY QUERY------

-----THIS QUERY IS DIFFERENT THAN MOST...GO INTO THE HLC AND DETERMINE THE NAME OF THE NODE THAT WAS CREATED FOR NURSE RESIDENCY PATHWAY (USUALLY IT IS NAMED SOMETHING LIKE "ABC HOSPITAL NURSE RESIDENCY PATHWAY"). ONCE YOU IDENTIFY THE NAME OF THE NODE FIND THE FACILITY GUID (ID) FOR THAT NODE (THIS CAN BE FOUND SEVERAL PLACES, I RECOMMEND USING THE ALL_ORGS_INSTITUTION_REPORT. 
...
set @Facility_GUID = --insert Faciity GUID for Nurse Residency
---------------------------------------------------------------
...
and ci.course_name_at_time_of_enrollment like 'NRSRES%'
and ci.course_instance_status_id = 3


and inst.org_node_id = @Facility_GUID
